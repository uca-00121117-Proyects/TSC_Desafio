...
public class _8_2_K implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._8_1;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._8_2;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._8_3;
    String fxmlnext = fxml.getdatos();

    //Rutas pantallas del menu
    routes p1 = routes.r_8_2_1;
    String d1 = p1.getroutes();
    routes p2 = routes.r_8_2_2;
    String d2 = p2.getroutes();
    routes p3 = routes.r_8_2_3;
    String d3 = p3.getroutes();
    routes p4 = routes.r_8_2_4;
    String d4 = p4.getroutes();
    routes p5 = routes.r_8_2_5;
    String d5 = p5.getroutes();
    routes p6 = routes.r_8_2_6;
    String d6 = p6.getroutes();
    routes p7 = routes.r_8_2_7;
    String d7 = p7.getroutes();
    routes p8 = routes.r_8_2_8;
    String d8= p8.getroutes();
    routes p9 = routes.r_8_2_9;
    String d9 = p9.getroutes();
    routes p10 = routes.r_8_2_10;
