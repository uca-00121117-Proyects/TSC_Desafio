...
public class _9_3 implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._9_2;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._9_3;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._10;
    String fxmlnext = fxml.getdatos();
    //Rutas pantallas del menu
    routes p9_1 = routes.r_9_3_1;
    String d1 = p9_1.getroutes();
    routes p9_2 = routes.r_9_3_2;
    String d2 = p9_2.getroutes();
    routes p9_3 = routes.r_9_3_3;
    String d3 = p9_3.getroutes();
    routes p9_4 = routes.r_9_3_4;
    String d4 = p9_4.getroutes();
    routes p9_5 = routes.r_9_3_5;
    String d5 = p9_5.getroutes();
