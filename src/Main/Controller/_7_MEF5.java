...
public class _7_MEF5 implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._7_4;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._7_5;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._7_6;
    String fxmlnext = fxml.getdatos();
    //Rutas pantallas del menu
    routes path7_1 = routes.r_7_5_1;
    String d_7_1 = path7_1.getroutes();
    routes path7_2 = routes.r_7_5_2;
    String d_7_2 = path7_2.getroutes();
    routes path7_3 = routes.r_7_5_3;
