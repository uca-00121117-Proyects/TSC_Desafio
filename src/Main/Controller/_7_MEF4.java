...
public class _7_MEF4 implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._7_3;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._7_4;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._7_5;
    String fxmlnext = fxml.getdatos();
    //Rutas pantallas del menu
    routes path7_1 = routes.r_7_4_1;
    String d_7_1 = path7_1.getroutes();
    routes path7_2 = routes.r_7_4_2;
    String d_7_2 = path7_2.getroutes();
    routes path7_3 = routes.r_7_4_3;
