...
public class _8_3_f implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._8_2;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._8_3;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._8_4;
    String fxmlnext = fxml.getdatos();

    //Rutas pantallas del menu
    routes p1 = routes.r_8_3_1;
    String d1 = p1.getroutes();
    routes p2 = routes.r_8_3_2;
    String d2 = p2.getroutes();
    routes p3 = routes.r_8_3_3;
    String d3 = p3.getroutes();
//    routes p4 = routes.r_8_3_4;
//    String d4 = p4.getroutes();
//    routes p5 = routes.r_8_3_5;
