...
public class _8_5_H implements Initializable {
    fxmlvalues fxmlp = fxmlvalues._8_4;
    String fxmlprev = fxmlp.getdatos();
    fxmlvalues fxmlt = fxmlvalues._8_5;
    String fxmlthis = fxmlt.getdatos();
    fxmlvalues fxml = fxmlvalues._8_6;
    String fxmlnext = fxml.getdatos();

    //Rutas pantallas del menu
    routes p1 = routes.r_8_5_1;
    String d1 = p1.getroutes();
    routes p2 = routes.r_8_5_2;
    String d2 = p2.getroutes();
    routes p3 = routes.r_8_5_3;
    String d3 = p3.getroutes();
    routes p4 = routes.r_8_5_4;
    String d4 = p4.getroutes();
    routes p5 = routes.r_8_5_5;
    String d5 = p5.getroutes();
    routes p6 = routes.r_8_5_6;
    String d6 = p6.getroutes();
    routes p7 = routes.r_8_5_7;
    String d7 = p7.getroutes();
    routes p8 = routes.r_8_5_8;
    String d8= p8.getroutes();
    routes p9 = routes.r_8_5_9;
    String d9 = p9.getroutes();
    routes p10 = routes.r_8_5_10;
